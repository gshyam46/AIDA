...
const GET_ENDPOINTS = new Set(['catalog', 'examples', 'health', 'schema', 'sources', 'auth/session', 'security/events'])
...
async function proxy(request: NextRequest, context: RouteContext) {
  ...
  const allowed = request.method === 'GET'
    ...
    : request.method === 'POST' && (POST_ENDPOINTS.has(endpoint) || configurePath)
