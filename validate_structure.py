...
REQUIRED = [
    "backend/main.py", "backend/core/analytics.py", "backend/core/semantic.py",
    "backend/core/hybrid.py", "backend/core/sources.py", "backend/core/catalog_engine.py",
    "backend/core/relational.py", "backend/core/relational_semantic.py",
    ...
    "scripts/start-demo.ps1", "scripts/stop-demo.ps1", "scripts/evaluate_semantics.py",
